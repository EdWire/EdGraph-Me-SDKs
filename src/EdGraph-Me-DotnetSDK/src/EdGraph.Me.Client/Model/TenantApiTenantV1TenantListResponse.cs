...
{
    /// <summary>
    /// TenantApiTenantV1TenantListResponse
    /// </summary>
    [DataContract(Name = "TenantApi.Tenant.V1.TenantListResponse")]
    public partial class TenantApiTenantV1TenantListResponse : IEquatable<TenantApiTenantV1TenantListResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApiTenantV1TenantListResponse" /> class.
        /// </summary>
        ...
        public List<TenantApiTenantV1SubscriptionListResponse> Subscriptions { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantApiTenantV1TenantListResponse {\n");
        ...
        {
            return this.Equals(input as TenantApiTenantV1TenantListResponse);
        }

        /// <summary>
        /// Returns true if TenantApiTenantV1TenantListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiTenantV1TenantListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiTenantV1TenantListResponse input)
        {
            if (input == null)
            {
                return false;
